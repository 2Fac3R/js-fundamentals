...
characters.forEach((element) => console.log(element.name));
const characterNames = characters.forEach((element) => element.name);
console.log(characterNames); // undefined

characters.map((element) => console.log(element.serie));
const characterNameAndserie = characters.map((element) => [element.name, element.serie]);
...
const fruitsAndVegetables = fruits.concat(vegetables); // merging two or more arrays
...
const orange = fruits.slice(2); // method slices out a piece of an array into a new array
console.log(orange);
console.log(fruits); // Notice: 'Orange' is still in the elements

const numbers = [255, 412, 124, 624];
